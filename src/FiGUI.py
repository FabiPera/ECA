...
class SimulationTab(Gtk.Box):	
	...
	adjWidth = Gtk.Adjustment.new(8, 8, 16385, 8, 1, 1)
	adjHeight = Gtk.Adjustment.new(8, 8, 16385, 8, 1, 1)
...
class AnalysisTab(Gtk.Box):
	...
	lyapCheck = Gtk.Switch.new()
	densCheck = Gtk.Switch.new()
	entrCheck = Gtk.Switch.new()
	meanCheck = Gtk.Switch.new()
	...
	labelMean = Gtk.Label("Mean Field:", xalign=0)
	...
	def __init__(self):
		...
		switchbox1 = Gtk.Box(orientation=0)
		checkbox1 = Gtk.Box(orientation=0)
		checkbox2 = Gtk.Box(orientation=0)
		checkbox3 = Gtk.Box(orientation=0)
		checkbox4 = Gtk.Box(orientation=0)

		switchbox1.pack_start(self.switchSrc, 0, 0, 0)
		checkbox1.pack_start(self.densCheck, 0, 0, 0)
		checkbox2.pack_start(self.entrCheck, 0, 0, 0)
		checkbox3.pack_start(self.lyapCheck, 0, 0, 0)
		checkbox4.pack_start(self.meanCheck, 0, 0, 0)
		...
		vbox1.pack_start(self.labelMean, 1, 1, 0)
		vbox1.pack_start(self.labelDefect, 1, 1, 0)
		vbox1.pack_start(self.labelStrLength, 1, 1, 0)
		vbox2.pack_start(switchbox1, 1, 1, 0)
		vbox2.pack_start(checkbox1, 1, 1, 0)
		vbox2.pack_start(checkbox2, 1, 1, 0)
		vbox2.pack_start(checkbox3, 1, 1, 0)
		vbox2.pack_start(checkbox4, 1, 1, 0)
